...
public class Gui {
    ...
    private void placeBtn(int width, int height) {
        ...
        btn[6].setBounds(width+5*draw.getWidth()/20-20, height+5*draw.getHeight()/20-20, 40, 40);
        btn[4].setBounds(width+10*draw.getWidth()/20-20, height+5*draw.getHeight()/20-20, 40, 40);
        btn[7].setBounds(width+15*draw.getWidth()/20-20, height+5*draw.getHeight()/20-20, 40, 40);
        btn[11].setBounds(width+8*draw.getWidth()/20-20, height+8*draw.getHeight()/20-20, 40, 40);
        btn[9].setBounds(width+10*draw.getWidth()/20-20, height+8*draw.getHeight()/20-20, 40, 40);
        btn[12].setBounds(width+12*draw.getWidth()/20-20, height+8*draw.getHeight()/20-20, 40, 40);
        btn[3].setBounds(width+2*draw.getWidth()/20-20, height+draw.getHeight()/2-20, 40, 40);
        btn[8].setBounds(width+5*draw.getWidth()/20-20, height+draw.getHeight()/2-20, 40, 40);
        btn[13].setBounds(width+8*draw.getWidth()/20-20, height+draw.getHeight()/2-20, 40, 40);
        btn[14].setBounds(width+12*draw.getWidth()/20-20, height+draw.getHeight()/2-20, 40, 40);
        btn[10].setBounds(width+15*draw.getWidth()/20-20, height+draw.getHeight()/2-20, 40, 40);
        btn[5].setBounds(width+18*draw.getWidth()/20-20, height+draw.getHeight()/2-20, 40, 40);
