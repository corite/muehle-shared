...
public class Gui {
    ...
    public Gui(){
        ...
        coordinates.sort(((o1, o2) -> Integer.compare(o1.getY(),o2.getY()) == 0 ? Integer.compare(o1.getX(), o2.getX()) : -Integer.compare(o1.getY(),o2.getY())));
    ...
    private void placeBtn(int width, int height) {
        ...
        btn[15].setBounds(width+2*draw.getWidth()/20-20, height+18*draw.getHeight()/20-20, 40, 40);
        btn[16].setBounds(width+10*draw.getWidth()/20-20, height+18*draw.getHeight()/20-20, 40, 40);
        btn[17].setBounds(width+18*draw.getWidth()/20-20, height+18*draw.getHeight()/20-20, 40, 40);
        ...
        btn[21].setBounds(width+8*draw.getWidth()/20-20, height+12*draw.getHeight()/20-20, 40, 40);
        btn[22].setBounds(width+10*draw.getWidth()/20-20, height+12*draw.getHeight()/20-20, 40, 40);
        btn[23].setBounds(width+12*draw.getWidth()/20-20, height+12*draw.getHeight()/20-20, 40, 40);
    }
}
